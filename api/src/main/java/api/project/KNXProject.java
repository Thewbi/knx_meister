...
public class KNXProject {
    ...
    private Map<String, Map<String, String>> languageStoreMap = new HashMap<>();
    ...
    public void setLanguageStoreMap(final Map<String, Map<String, String>> languageStoreMap) {
        this.languageStoreMap = languageStoreMap;
    }

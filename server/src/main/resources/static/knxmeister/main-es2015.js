...
let AppComponent = class AppComponent {
    ...
    onClickMe() {
        console.log('click');
        this.http.get('http://127.0.0.1:8182/knxmeister/api/system/version')
            .subscribe(res => console.log('HTTP response', res), err => console.log('HTTP Error', err), () => console.log('complete'));
        //// get with URL params
...
module.exports = __webpack_require__(/*! C:\dev\knx_meister\server\src\main\resources\frontend\angular-app\src\main.ts */"./src/main.ts");

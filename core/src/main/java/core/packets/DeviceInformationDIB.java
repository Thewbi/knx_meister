...
public class DeviceInformationDIB extends DescriptionInformationBlock {
    ...
    public String toString() {
        ...
        stringBuilder.append("KNX Individual Address: ")
                .append(Utils.integerToKNXAddress(individualAddress, Utils.SEPARATOR)).append(" ")
                .append(Utils.integerToString(individualAddress)).append("\n");
